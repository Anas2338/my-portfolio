    ...
    return(
        <div className="w-auto flex flex-col gap-8 md:grid md:grid-cols-2  md:justify-items-center lg:grid lg:grid-cols-3 lg:px-[40px] lg:py-[80px]  mx-[40px] items-center py-[40px] ">
            <div  className="flex flex-col bg-[#2982b6] w-[328] h-[292] py-[35] px-[40] gap-[20] rounded-2xl">
              <div  className=" w-[100px] h-[100px]  gap-[10]  "  ><Image className="rounded-[10] " src={trading} alt="trading logo"></Image></div>
            ...
            <div  className="flex flex-col bg-[#2982b6] w-[328] h-[292] py-[35] px-[40] gap-[20] rounded-2xl">
              <div  className=" w-[100] h-[100]   gap-[10] "  ><Image className="rounded-[10]" src={stenography} alt="stenography logo"></Image></div>
            ...
            <div  className="flex flex-col bg-[#2982b6] w-[328] h-[292] py-[35] px-[40] gap-[20] rounded-2xl">
              <div  className=" w-[100] h-[100]  gap-[10] " ><Image className="rounded-[10]" src={repairing} alt="repairing logo"></Image></div>
            ...
            <div  className="flex flex-col bg-[#2982b6] w-[328] h-[292] py-[35] px-[40] gap-[20] rounded-2xl">
              <div  className=" w-[100] h-[100]   gap-[10] "  ><Image className="rounded-[10]" src={webdevelopment} alt="web development logo"></Image></div>
