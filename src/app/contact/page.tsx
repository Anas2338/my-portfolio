...
export default function Contact (){
    return(
        <div className="w-auto flex flex-col gap-[100px] mx-[60px] px-[20px] py-[40px] ">
            <div className="text-center">
                <h1 className="font-serif font-bold text-5xl leading-[40px] tracking-wide text-[#252B42]">Contact Me</h1>
            </div>
            <div className="text-white flex flex-col gap-10 sm:grid sm:grid-cols-2 sm:gap-14 sm:px-[20px] lg:px-[40px]">
                <button>
                    <div className="flex w-auto h-[80px] border-2 border-white bg-blue-900 rounded-3xl items-center gap-10 pl-4">
